...
В боте: добавление («такси 350», «вчера хлеб 200»), отчёты за 1/7/30 дней, лимиты, удаление
(кнопка «🗑 Удалить трату», «↩️ Отменить» сразу после добавления, `/undo`), автоотчёты каждому пользователю.
